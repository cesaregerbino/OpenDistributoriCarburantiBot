...
<head>
  ...
  */
    ...
    #print "La url di richiamo a MapQuest ...".$url;
    #echo '<br>';
    #echo '<br>';
...
//       var mapbox_access_token = <?php echo json_encode($MapBoxAccessToken); ?>;
...
//       var mapbox_layer = "https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=" + mapbox_access_token;
//       L.tileLayer(mapbox_layer, {
//       		maxZoom: 18,
...
//             }).addTo(map);
       ...
       L.tileLayer('http://dev.opentopomap.org/{z}/{x}/{y}.png', {
			maxZoom: 18,
...
//       }).addTo(map);
       ...
       L.geoJson(lineString, {style: lineStyle} ).addTo(map);
  ...
  <body>
    ...
    <script>
      ...
      var osmb = new OSMBuildings({
        ...
        minZoom: 15,
        maxZoom: 22,
        attribution: '&copy; 3D <a href="http://osmbuildings.org/copyright/">OSM Buildings</a>'
      }).addTo(map);

      //# Add the OSM basemap (MapQuest)  ...
      osmb.addMapTiles(
        'http://{s}.tiles.mapbox.com/v3/osmbuildings.kbpalbpk/{z}/{x}/{y}.png',
//        'http://dev.opentopomap.org/{z}/{x}/{y}.png',
        {
        attribution: '&copy; Data <a href="http://openstreetmap.org/copyright/">OpenStreetMap</a> &copy; Map <a href="http://mapbox.com">MapBox</a>'
        }
      );
